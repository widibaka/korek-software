  ...
  <body class="bg-light">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="#">Ringkas</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo base_url('jadwal/lengkap') ?>">Lengkap</a>
          </li>
        </ul>
    ...
    <main role="main" class="container">
      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">Jadwal hari ini</h6>
