  ...
  <body class="bg-light">
    ...
    <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="offcanvas">Pilih kelas dulu!</a>
          </li>
          <li class="nav-item">
    ...
    <main role="main" class="container">
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-z2 rounded box-shadow">
        ...
        <div class="lh-100">
          <h6 class="mb-0 text-white lh-100">Pilih kelas kamu</h6>
          <small></small>
        </div>
      </div>
      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <ul class="list-group" id="daftar_kelas">
          <?php foreach ($classes as $key => $value): ?>
            ...
            <a class="mb-2" href="<?php echo base_url('jadwal/kelas/') . $jurusan . "/" . $value ?>"><li class="font-weight-bold text-center btn btn-primary" style="width: 100%"><?php echo $value ?></li></a>
